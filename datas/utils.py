...
from datas.div2k_new import DIV2K
...
def create_datasets(args):
    ...
    if 'Set5' in args.eval_sets:
        ...
        set5_lr_path = os.path.join(args.data_path, 'benchmark/Set5/LR_bicubic/x4')
    ...
    if 'Set14' in args.eval_sets:
        ...
        set14_lr_path = os.path.join(args.data_path, 'benchmark/Set14/LR_bicubic/x4')
    ...
    if 'B100' in args.eval_sets:
        ...
        b100_lr_path = os.path.join(args.data_path, 'benchmark/B100/LR_bicubic/x4')
    ...
    if 'Urban100' in args.eval_sets:
        ...
        u100_lr_path = os.path.join(args.data_path, 'benchmark/Urban100/LR_bicubic/x4')
    ...
    if 'Manga109' in args.eval_sets:
        ...
        manga_lr_path = os.path.join(args.data_path, 'benchmark/Manga109/LR_bicubic/x4')
