...
class ELARN(nn.Module):
     def __init__(self,args,scale=2, colors=3, r_expand=1, c_elan=64, m_elan=10, n_share=2, window_sizes=[3, 5, 7],drop_path=0.):
         super().__init__()
         self.hed = args.hed
         self.scale =  args.scale
         self.colors =  args.colors  # Assuming RGB
         self.r_expand =  args.r_expand  # Assuming some value
         self.c_elan =  args.c_elan  # Assuming some value
         self.m_elan =  args.m_elan  # Assuming some value
         self.n_share =  args.n_share  # Assuming some value
